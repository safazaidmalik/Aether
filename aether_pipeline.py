...
populated_kg_path = '/home/szm/Documents/Uni_Stuff/Sem8/MLOps/Project/Populated_Assets_KG.ttl'
# Update KG of assets
#################################################
import os
import json
...
def find_similar_asset_cos(in_asset_desc_pair, KG_info):
    ...
    try:
        KG_info[0][str(
            'http://www.semanticweb.org/szm/megascan-assets-ontology#Asset_') + closest_asset_ID]
    except Exception as e:
    ...
    return in_asset_Name, KG_info[0][str('http://www.semanticweb.org/szm/megascan-assets-ontology#Asset_') + closest_asset_ID], KG_info[1][str('http://www.semanticweb.org/szm/megascan-assets-ontology#Asset_') + closest_asset_ID]
